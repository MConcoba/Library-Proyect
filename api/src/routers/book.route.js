...
api.delete('/delete-book/:idBook', md_auth.ensureAuth, BookController.deleteBook);
...
api.get('/get-books-avaible', md_auth.ensureAuth, BookController.getBooksAviablesUser);
